...
public:
	...
	virtual bool ReadProperty(TSharedPtr<FCEFJSScriptingEx> Scripting, FProperty* Property, FProperty* Outer, void* Data, int32 ArrayIndex) = 0;
...
public:
	...
	virtual bool ReadProperty(TSharedPtr<FCEFJSScriptingEx> Scripting, FProperty* Property, FProperty* Outer, void* Data, int32 ArrayIndex ) override;
