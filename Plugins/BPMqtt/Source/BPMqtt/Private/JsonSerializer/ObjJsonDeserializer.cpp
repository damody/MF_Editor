...
UObjJsonDeserializer::UObjJsonDeserializer()
{
}

UObject* UObjJsonDeserializer::JsonObjectToUObject(const TSharedPtr<FJsonObject>& JsonObject, UClass* TargetClass /*=nullptr*/)
{
	...
	{
		JsonPropertyToFProperty(JsonObject, *PropIt, createdObj, false);
	}
...
AActor* UObjJsonDeserializer::JsonObjectToActor(const TSharedPtr<FJsonObject>& JsonObject, AActor* TargetActor /*= nullptr*/)
{
	if (!TargetActor) return nullptr;
	for (TFieldIterator<FProperty> PropIt(TargetActor->GetClass()); PropIt; ++PropIt)
	{
		JsonPropertyToFProperty(JsonObject, *PropIt, TargetActor, true);
	}
	return TargetActor;
}

bool UObjJsonDeserializer::JsonPropertyToFProperty(const TSharedPtr<FJsonObject>& JsonObject, FProperty* Property, UObject* OutObject, bool IsActor)
{
	FObjectProperty* ObjectProperty = CastField<FObjectProperty>(Property);
	if (ObjectProperty && IsActor)
	{
		// skip Object
		return true;
	}
...
bool UObjJsonDeserializer::JsonObjectToUStruct(const TSharedPtr<FJsonObject>& JsonObject, const UStruct* StructDefinition, void* OutStruct)
{
	auto& JsonAttributes = JsonObject->Values;
...
bool UObjJsonDeserializer::JsonValueToFProperty(const TSharedPtr<FJsonValue>& JsonValue, FProperty* Property, void* OutValue)
{
...
bool UObjJsonDeserializer::ConvertScalarJsonValueToFPropertyWithContainer(const TSharedPtr<FJsonValue>& JsonValue, FProperty* Property, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFEnumProperty(const TSharedPtr<FJsonValue>& JsonValue, FEnumProperty* Property, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFNumericProperty(const TSharedPtr<FJsonValue>& JsonValue, FNumericProperty* NumericProperty, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFBoolProperty(const TSharedPtr<FJsonValue>& JsonValue, FBoolProperty* BoolProperty, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFStrProperty(const TSharedPtr<FJsonValue>& JsonValue, FStrProperty* StringProperty, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFArrayProperty(const TSharedPtr<FJsonValue>& JsonValue, FArrayProperty* ArrayProperty, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFMapProperty(const TSharedPtr<FJsonValue>& JsonValue, FMapProperty* MapProperty, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFSetProperty(const TSharedPtr<FJsonValue>& JsonValue, FSetProperty* SetProperty, void* OutValue)
{
	if (JsonValue->Type == EJson::Array)
	{
		TArray< TSharedPtr<FJsonValue> > ArrayValue = JsonValue->AsArray();
...
bool UObjJsonDeserializer::JsonValueToFTextProperty(const TSharedPtr<FJsonValue>& JsonValue, FTextProperty* TextProperty, void* OutValue)
{
	if (JsonValue->Type == EJson::String)
	{
...
bool UObjJsonDeserializer::JsonValueToFStructProperty(const TSharedPtr<FJsonValue>& JsonValue, FStructProperty* StructProperty, void* OutValue)
{
...
bool UObjJsonDeserializer::JsonValueToFObjectProperty(const TSharedPtr<FJsonValue>& JsonValue, FObjectProperty* ObjectProperty, void* OutValue)
{
	if (JsonValue->Type == EJson::Object)
	{
